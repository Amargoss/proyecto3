          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-600 mb-4 max-w-md">
                A professional full-stack application built with modern technologies 
                and enterprise-grade architecture. Featuring React, Node.js, PostgreSQL, 
                and comprehensive DevOps practices.
              </p>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-500 text-sm">
                © 2024 Proyecto3. Built with modern full-stack technologies.
              </p>
